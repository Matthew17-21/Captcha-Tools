...
// TestAnticaptchaGetV2Additional tests that it can successfully get a V2 token from 2Captcha
...
// Test2AntiCaptchaGetImage tests that it can successfully solve a image captcha
// to run this specific test:
	...
	configs := []testConfigs{
		{
			...
			Config:      &Config{Api_key: antiCapKey, CaptchaType: ImageCaptcha},
